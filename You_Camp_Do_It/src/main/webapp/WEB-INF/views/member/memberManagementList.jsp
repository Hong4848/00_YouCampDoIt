...
<html>
        ...
        <div id="outer">
            ...
            <div class="manager_content">
				<div class="management_title">
                    <div style="line-height: 47px; padding-left: 20px;">회원 정보 관리</div>
                ...
                <div class="management_content">
                    ...
                    <div class="goodsList">
                        <div class="goodsListInfo">
                            ...
                            <div class="memberName_Info">
                                이름
                            </div>
                            <div class="birthDate_Info">
                                생일
                            </div>
    ...
    <script>
        ...
        $(document).ready(function(){
            ...
            $("#userInfo").children().css("color","red");
    ...
    <script>
        function ajaxResult(result, i){
         ...
         // 월 한글 데이터를 숫자로 매핑
            ...
            // JSON에서 불러온 date 값
            let date = result.list[i].birthDate; // "1월 1, 1990"
            ...
            resultStr += "<div class='goodsNo_checkbox'>"
                            + "<label class='labelClass' for='check_" + (i+1) + "'>"+ result.list[i].memberNo +"</label>"
                        + "</div>"
                        + "<div class='memberId_Info' style='text-align:center;'>"
                            + result.list[i].memberId
                        + "</div>"
                        + "<div class='memberName_Info'>"
