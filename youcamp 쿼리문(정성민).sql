...
SELECT C.SECTION AS SECTION, COUNT(C.CAMPSITE_ID) AS "REST_COUNT"
 ...
 WHERE C.CAMPSITE_ID NOT IN (
          ...
          FROM RESERVE R
          WHERE 
              TRUNC(R.START_DATE) < TO_DATE('2024-01-08', 'YYYY-MM-DD') 
              AND TRUNC(R.END_DATE) > TO_DATE('2024-01-06', 'YYYY-MM-DD') 
...
SELECT R.RESERVE_NO, M.MEMBER_NAME, R.START_DATE, R.END_DATE, R.NIGHTS, R.MEMBER_COUNT
  FROM RESERVE R
  JOIN CAMPSITE C ON(R.CAMPSITE_ID = C.CAMPSITE_ID)
...
SELECT R.RESERVE_NO, M.MEMBER_NAME, R.PAYMENT_DATE, R.PAYMENT_METHOD, R.PAYMENT_STATUS, C.SECTION, C.SPOT_NO
  FROM RESERVE R
  JOIN CAMPSITE C ON (R.CAMPSITE_ID = C.CAMPSITE_ID)
  JOIN MEMBER M ON (R.MEMBER_NO = M.MEMBER_NO)
  JOIN CAMPSITE C ON (R.CAMPSITE_ID = C.CAMPSITE_ID)
 WHERE R.RESERVE_NO = 4

 
INSERT INTO MEMBER(MEMBER_NO, MEMBER_ID, MEMBER_PWD, MEMBER_NAME, BIRTH_DATE, PHONE, EMAIL, SIGNUP_DATE, ADDRESS)
VALUES(MEMBER_SEQ.NEXTVAL, 'user04', '$2a$10$eOGLex8k5BG.HHFkJYX.6eaOLJ6NCTEjJQK1z.L5Gb1Nu5cMMvL/u', '홍길동', '1990-01-01', '010-1234-5678', 'user04@example.com', '2024-12-22', '서울특별시 중구 을지로');
INSERT INTO MEMBER(MEMBER_NO, MEMBER_ID, MEMBER_PWD, MEMBER_NAME, BIRTH_DATE, PHONE, EMAIL, SIGNUP_DATE, ADDRESS)
VALUES(MEMBER_SEQ.NEXTVAL, 'user05', '$2a$10$eOGLex8k5BG.HHFkJYX.6eaOLJ6NCTEjJQK1z.L5Gb1Nu5cMMvL/u', '홍길동', '1990-01-01', '010-1234-5678', 'user05@example.com', '2024-12-22', '서울특별시 중구 을지로');
INSERT INTO MEMBER(MEMBER_NO, MEMBER_ID, MEMBER_PWD, MEMBER_NAME, BIRTH_DATE, PHONE, EMAIL, SIGNUP_DATE, ADDRESS)
VALUES(MEMBER_SEQ.NEXTVAL, 'user06', '$2a$10$eOGLex8k5BG.HHFkJYX.6eaOLJ6NCTEjJQK1z.L5Gb1Nu5cMMvL/u', '홍길동', '1990-01-01', '010-1234-5678', 'user06@example.com', '2024-12-22', '서울특별시 중구 을지로');
INSERT INTO MEMBER(MEMBER_NO, MEMBER_ID, MEMBER_PWD, MEMBER_NAME, BIRTH_DATE, PHONE, EMAIL, SIGNUP_DATE, ADDRESS)
VALUES(MEMBER_SEQ.NEXTVAL, 'user07', '$2a$10$eOGLex8k5BG.HHFkJYX.6eaOLJ6NCTEjJQK1z.L5Gb1Nu5cMMvL/u', '홍길동', '1990-01-01', '010-1234-5678', 'user07@example.com', '2024-12-22', '서울특별시 중구 을지로');
INSERT INTO MEMBER(MEMBER_NO, MEMBER_ID, MEMBER_PWD, MEMBER_NAME, BIRTH_DATE, PHONE, EMAIL, SIGNUP_DATE, ADDRESS)
VALUES(MEMBER_SEQ.NEXTVAL, 'user08', '$2a$10$eOGLex8k5BG.HHFkJYX.6eaOLJ6NCTEjJQK1z.L5Gb1Nu5cMMvL/u', '홍길동', '1990-01-01', '010-1234-5678', 'user08@example.com', '2024-12-22', '서울특별시 중구 을지로');
INSERT INTO MEMBER(MEMBER_NO, MEMBER_ID, MEMBER_PWD, MEMBER_NAME, BIRTH_DATE, PHONE, EMAIL, SIGNUP_DATE, ADDRESS)
VALUES(MEMBER_SEQ.NEXTVAL, 'user09', '$2a$10$eOGLex8k5BG.HHFkJYX.6eaOLJ6NCTEjJQK1z.L5Gb1Nu5cMMvL/u', '홍길동', '1990-01-01', '010-1234-5678', 'user09@example.com', '2024-12-22', '서울특별시 중구 을지로');
INSERT INTO MEMBER(MEMBER_NO, MEMBER_ID, MEMBER_PWD, MEMBER_NAME, BIRTH_DATE, PHONE, EMAIL, SIGNUP_DATE, ADDRESS)
VALUES(MEMBER_SEQ.NEXTVAL, 'user10', '$2a$10$eOGLex8k5BG.HHFkJYX.6eaOLJ6NCTEjJQK1z.L5Gb1Nu5cMMvL/u', '홍길동', '1990-01-01', '010-1234-5678', 'user10@example.com', '2024-12-22', '서울특별시 중구 을지로');
INSERT INTO MEMBER(MEMBER_NO, MEMBER_ID, MEMBER_PWD, MEMBER_NAME, BIRTH_DATE, PHONE, EMAIL, SIGNUP_DATE, ADDRESS)
VALUES(MEMBER_SEQ.NEXTVAL, 'user11', '$2a$10$eOGLex8k5BG.HHFkJYX.6eaOLJ6NCTEjJQK1z.L5Gb1Nu5cMMvL/u', '홍길동', '1990-01-01', '010-1234-5678', 'user11@example.com', '2024-12-22', '서울특별시 중구 을지로');
INSERT INTO MEMBER(MEMBER_NO, MEMBER_ID, MEMBER_PWD, MEMBER_NAME, BIRTH_DATE, PHONE, EMAIL, SIGNUP_DATE, ADDRESS)
VALUES(MEMBER_SEQ.NEXTVAL, 'user12', '$2a$10$eOGLex8k5BG.HHFkJYX.6eaOLJ6NCTEjJQK1z.L5Gb1Nu5cMMvL/u', '홍길동', '1990-01-01', '010-1234-5678', 'user12@example.com', '2024-12-22', '서울특별시 중구 을지로');
INSERT INTO MEMBER(MEMBER_NO, MEMBER_ID, MEMBER_PWD, MEMBER_NAME, BIRTH_DATE, PHONE, EMAIL, SIGNUP_DATE, ADDRESS)
VALUES(MEMBER_SEQ.NEXTVAL, 'user13', '$2a$10$eOGLex8k5BG.HHFkJYX.6eaOLJ6NCTEjJQK1z.L5Gb1Nu5cMMvL/u', '홍길동', '1990-01-01', '010-1234-5678', 'user13@example.com', '2024-12-22', '서울특별시 중구 을지로');
commit;
...
(RESERVE_SEQ.NEXTVAL, TO_DATE('2024-12-20', 'YYYY-MM-DD'), TO_DATE('2024-12-21', 'YYYY-MM-DD'), 1, 4, 'PAY202401', 60000, SYSDATE, 'CARD', 'PAID', SYSDATE, 2, 1);
INSERT INTO RESERVE (
    RESERVE_NO, START_DATE, END_DATE, NIGHTS, MEMBER_COUNT, PAYMENT_ID, PRICE,
    PAYMENT_DATE, PAYMENT_METHOD, PAYMENT_STATUS, UPDATE_DATE,
    MEMBER_NO, CAMPSITE_ID
) VALUES
(RESERVE_SEQ.NEXTVAL, TO_DATE('2024-12-21', 'YYYY-MM-DD'), TO_DATE('2024-12-23', 'YYYY-MM-DD'), 2, 4, 'PAY202402', 120000, SYSDATE, 'BANK', 'PAID', SYSDATE, 3, 2);
INSERT INTO RESERVE (
    RESERVE_NO, START_DATE, END_DATE, NIGHTS, MEMBER_COUNT, PAYMENT_ID, PRICE,
    PAYMENT_DATE, PAYMENT_METHOD, PAYMENT_STATUS, UPDATE_DATE,
    MEMBER_NO, CAMPSITE_ID
) VALUES
(RESERVE_SEQ.NEXTVAL, TO_DATE('2024-12-22', 'YYYY-MM-DD'), TO_DATE('2024-12-23', 'YYYY-MM-DD'), 1, 4, 'PAY202403', 60000, SYSDATE, 'VBANK', 'CREATED', SYSDATE, 4, 3);
INSERT INTO RESERVE (
    RESERVE_NO, START_DATE, END_DATE, NIGHTS, MEMBER_COUNT, PAYMENT_ID, PRICE,
    PAYMENT_DATE, PAYMENT_METHOD, PAYMENT_STATUS, UPDATE_DATE,
    MEMBER_NO, CAMPSITE_ID
) VALUES
(RESERVE_SEQ.NEXTVAL, TO_DATE('2024-12-23', 'YYYY-MM-DD'), TO_DATE('2024-12-25', 'YYYY-MM-DD'), 2, 4, 'PAY202404', 120000, SYSDATE, 'CELLPHONE', 'PAID', SYSDATE, 2, 4);
INSERT INTO RESERVE (
    RESERVE_NO, START_DATE, END_DATE, NIGHTS, MEMBER_COUNT, PAYMENT_ID, PRICE,
    PAYMENT_DATE, PAYMENT_METHOD, PAYMENT_STATUS, UPDATE_DATE,
    MEMBER_NO, CAMPSITE_ID
) VALUES
(RESERVE_SEQ.NEXTVAL, TO_DATE('2024-12-24', 'YYYY-MM-DD'), TO_DATE('2024-12-25', 'YYYY-MM-DD'), 1, 4, 'PAY202405', 60000, SYSDATE, 'CARD', 'PAID', SYSDATE, 3, 5);
INSERT INTO RESERVE (
    RESERVE_NO, START_DATE, END_DATE, NIGHTS, MEMBER_COUNT, PAYMENT_ID, PRICE,
    PAYMENT_DATE, PAYMENT_METHOD, PAYMENT_STATUS, UPDATE_DATE,
    MEMBER_NO, CAMPSITE_ID
) VALUES
(RESERVE_SEQ.NEXTVAL, TO_DATE('2024-12-25', 'YYYY-MM-DD'), TO_DATE('2024-12-27', 'YYYY-MM-DD'), 2, 4, 'PAY202406', 120000, SYSDATE, 'BANK', 'CANCELED', SYSDATE, 4, 6);
INSERT INTO RESERVE (
    RESERVE_NO, START_DATE, END_DATE, NIGHTS, MEMBER_COUNT, PAYMENT_ID, PRICE,
    PAYMENT_DATE, PAYMENT_METHOD, PAYMENT_STATUS, UPDATE_DATE,
    MEMBER_NO, CAMPSITE_ID
) VALUES
(RESERVE_SEQ.NEXTVAL, TO_DATE('2024-12-26', 'YYYY-MM-DD'), TO_DATE('2024-12-27', 'YYYY-MM-DD'), 1, 4, 'PAY202407', 60000, SYSDATE, 'VBANK', 'PAID', SYSDATE, 2, 7);
INSERT INTO RESERVE (
    RESERVE_NO, START_DATE, END_DATE, NIGHTS, MEMBER_COUNT, PAYMENT_ID, PRICE,
    PAYMENT_DATE, PAYMENT_METHOD, PAYMENT_STATUS, UPDATE_DATE,
    MEMBER_NO, CAMPSITE_ID
) VALUES
(RESERVE_SEQ.NEXTVAL, TO_DATE('2024-12-27', 'YYYY-MM-DD'), TO_DATE('2024-12-29', 'YYYY-MM-DD'), 2, 4, 'PAY202408', 120000, SYSDATE, 'CELLPHONE', 'PAID', SYSDATE, 3, 8);
INSERT INTO RESERVE (
    RESERVE_NO, START_DATE, END_DATE, NIGHTS, MEMBER_COUNT, PAYMENT_ID, PRICE,
    PAYMENT_DATE, PAYMENT_METHOD, PAYMENT_STATUS, UPDATE_DATE,
    MEMBER_NO, CAMPSITE_ID
) VALUES
(RESERVE_SEQ.NEXTVAL, TO_DATE('2024-12-28', 'YYYY-MM-DD'), TO_DATE('2024-12-29', 'YYYY-MM-DD'), 1, 4, 'PAY202409', 60000, SYSDATE, 'CARD', 'CREATED', SYSDATE, 4, 9);
INSERT INTO RESERVE (
    RESERVE_NO, START_DATE, END_DATE, NIGHTS, MEMBER_COUNT, PAYMENT_ID, PRICE,
    PAYMENT_DATE, PAYMENT_METHOD, PAYMENT_STATUS, UPDATE_DATE,
    MEMBER_NO, CAMPSITE_ID
) VALUES
(RESERVE_SEQ.NEXTVAL, TO_DATE('2024-12-29', 'YYYY-MM-DD'), TO_DATE('2024-12-31', 'YYYY-MM-DD'), 2, 4, 'PAY202410', 120000, SYSDATE, 'BANK', 'PAID', SYSDATE, 2, 10);
INSERT INTO RESERVE (
    RESERVE_NO, START_DATE, END_DATE, NIGHTS, MEMBER_COUNT, PAYMENT_ID, PRICE,
    PAYMENT_DATE, PAYMENT_METHOD, PAYMENT_STATUS, UPDATE_DATE,
    MEMBER_NO, CAMPSITE_ID
) VALUES
(RESERVE_SEQ.NEXTVAL, TO_DATE('2024-12-30', 'YYYY-MM-DD'), TO_DATE('2024-12-31', 'YYYY-MM-DD'), 1, 4, 'PAY202411', 60000, SYSDATE, 'VBANK', 'PAID', SYSDATE, 3, 11);
INSERT INTO RESERVE (
    RESERVE_NO, START_DATE, END_DATE, NIGHTS, MEMBER_COUNT, PAYMENT_ID, PRICE,
    PAYMENT_DATE, PAYMENT_METHOD, PAYMENT_STATUS, UPDATE_DATE,
    MEMBER_NO, CAMPSITE_ID
) VALUES
(RESERVE_SEQ.NEXTVAL, TO_DATE('2024-12-31', 'YYYY-MM-DD'), TO_DATE('2025-01-02', 'YYYY-MM-DD'), 2, 4, 'PAY202412', 120000, SYSDATE, 'CELLPHONE', 'REFUNDED', SYSDATE, 4, 12);
INSERT INTO RESERVE (
    RESERVE_NO, START_DATE, END_DATE, NIGHTS, MEMBER_COUNT, PAYMENT_ID, PRICE,
    PAYMENT_DATE, PAYMENT_METHOD, PAYMENT_STATUS, UPDATE_DATE,
    MEMBER_NO, CAMPSITE_ID
) VALUES
(RESERVE_SEQ.NEXTVAL, TO_DATE('2025-01-01', 'YYYY-MM-DD'), TO_DATE('2025-01-02', 'YYYY-MM-DD'), 1, 4, 'PAY202413', 60000, SYSDATE, 'CARD', 'PAID', SYSDATE, 2, 13);
INSERT INTO RESERVE (
    RESERVE_NO, START_DATE, END_DATE, NIGHTS, MEMBER_COUNT, PAYMENT_ID, PRICE,
    PAYMENT_DATE, PAYMENT_METHOD, PAYMENT_STATUS, UPDATE_DATE,
    MEMBER_NO, CAMPSITE_ID
) VALUES
(RESERVE_SEQ.NEXTVAL, TO_DATE('2025-01-02', 'YYYY-MM-DD'), TO_DATE('2025-01-04', 'YYYY-MM-DD'), 2, 4, 'PAY202414', 120000, SYSDATE, 'BANK', 'PAID', SYSDATE, 3, 14);
INSERT INTO RESERVE (
    RESERVE_NO, START_DATE, END_DATE, NIGHTS, MEMBER_COUNT, PAYMENT_ID, PRICE,
    PAYMENT_DATE, PAYMENT_METHOD, PAYMENT_STATUS, UPDATE_DATE,
    MEMBER_NO, CAMPSITE_ID
) VALUES
(RESERVE_SEQ.NEXTVAL, TO_DATE('2025-01-03', 'YYYY-MM-DD'), TO_DATE('2025-01-04', 'YYYY-MM-DD'), 1, 4, 'PAY202415', 60000, SYSDATE, 'VBANK', 'PAID', SYSDATE, 4, 15);
INSERT INTO RESERVE (
    RESERVE_NO, START_DATE, END_DATE, NIGHTS, MEMBER_COUNT, PAYMENT_ID, PRICE,
    PAYMENT_DATE, PAYMENT_METHOD, PAYMENT_STATUS, UPDATE_DATE,
    MEMBER_NO, CAMPSITE_ID
) VALUES
(RESERVE_SEQ.NEXTVAL, TO_DATE('2025-01-04', 'YYYY-MM-DD'), TO_DATE('2025-01-06', 'YYYY-MM-DD'), 2, 4, 'PAY202416', 120000, SYSDATE, 'CELLPHONE', 'PAID', SYSDATE, 2, 16);
INSERT INTO RESERVE (
    RESERVE_NO, START_DATE, END_DATE, NIGHTS, MEMBER_COUNT, PAYMENT_ID, PRICE,
    PAYMENT_DATE, PAYMENT_METHOD, PAYMENT_STATUS, UPDATE_DATE,
    MEMBER_NO, CAMPSITE_ID
) VALUES
(RESERVE_SEQ.NEXTVAL, TO_DATE('2025-01-05', 'YYYY-MM-DD'), TO_DATE('2025-01-06', 'YYYY-MM-DD'), 1, 4, 'PAY202417', 60000, SYSDATE, 'CARD', 'CREATED', SYSDATE, 3, 17);
INSERT INTO RESERVE (
    RESERVE_NO, START_DATE, END_DATE, NIGHTS, MEMBER_COUNT, PAYMENT_ID, PRICE,
    PAYMENT_DATE, PAYMENT_METHOD, PAYMENT_STATUS, UPDATE_DATE,
    MEMBER_NO, CAMPSITE_ID
) VALUES
(RESERVE_SEQ.NEXTVAL, TO_DATE('2025-01-06', 'YYYY-MM-DD'), TO_DATE('2025-01-08', 'YYYY-MM-DD'), 2, 4, 'PAY202418', 120000, SYSDATE, 'BANK', 'PAID', SYSDATE, 4, 18);
INSERT INTO RESERVE (
    RESERVE_NO, START_DATE, END_DATE, NIGHTS, MEMBER_COUNT, PAYMENT_ID, PRICE,
    PAYMENT_DATE, PAYMENT_METHOD, PAYMENT_STATUS, UPDATE_DATE,
    MEMBER_NO, CAMPSITE_ID
) VALUES
(RESERVE_SEQ.NEXTVAL, TO_DATE('2025-01-07', 'YYYY-MM-DD'), TO_DATE('2025-01-08', 'YYYY-MM-DD'), 1, 4, 'PAY202419', 60000, SYSDATE, 'VBANK', 'PAID', SYSDATE, 2, 19);
INSERT INTO RESERVE (
    RESERVE_NO, START_DATE, END_DATE, NIGHTS, MEMBER_COUNT, PAYMENT_ID, PRICE,
    PAYMENT_DATE, PAYMENT_METHOD, PAYMENT_STATUS, UPDATE_DATE,
    MEMBER_NO, CAMPSITE_ID
) VALUES
(RESERVE_SEQ.NEXTVAL, TO_DATE('2025-01-08', 'YYYY-MM-DD'), TO_DATE('2025-01-10', 'YYYY-MM-DD'), 2, 4, 'PAY202420', 120000, SYSDATE, 'CELLPHONE', 'PAID', SYSDATE, 3, 20);
COMMIT;
